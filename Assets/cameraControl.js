...
public var xMargin : float = 1f;		// Distance in the x axis the player can move before the camera follows.
public var yMargin : float = 1f;		// Distance in the y axis the player can move before the camera follows.
public var xSmooth : float = 8f;		// How smoothly the camera catches up with its target movement in the x axis.
public var ySmooth : float = 8f;		// How smoothly the camera catches up with its target movement in the y axis.
...
function Awake()
{
    ...
    player = GameObject.Find("Masaru").transform;
}
